...
<template>
  <div id="app">
    ...
    <div v-if="gameState === 'game'">
      <div class="panel">
        ...
        <div>
          <div class="panel__elt">
            <svg class="adnn-tick-icon" enable-background="new 0 0 24 24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
      ...
      <Table :key="tableKey" :points="points" @guessCorrect="guessCorrect"></Table>
    </div>
