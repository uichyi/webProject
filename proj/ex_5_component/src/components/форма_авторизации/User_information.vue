<template>
    <section class="h-100" style='background:#dbf0ff'>
                ...
                <div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6 mb-4">
                        <div data-mdb-input-init class="form-outline">
                          ...
                          <select class="form-select form-select-lg" id="leading_arm" required>
                  ...
                  <div class="row">
                    <div class="col-md-6 mb-4">
                      ...
                      <select class="form-select form-select-lg" id="education" required>
                        <option value="" selected></option>
                    ...
                    <div class="col-md-6 mb-4">
                      <div data-mdb-input-init class="form-outline">
                        ...
                        <input type="text" id="speciality" class="form-control form-control-lg" placeholder="Введите название" required/>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-md-6 mb-4">
                      ...
                      <select class="form-select form-select-lg" id="place_of_residence" required>
                        <option value="" selected></option>
                  ...
                  <div class="d-md-flex justify-content-start align-items-center mb-4 py-2">
                    <div class="form-check form-check-inline mb-0 me-4">
                      <input class="form-check-input" type="radio" name="inlineRadioOptions" id="very_bad"
                        value="1" required/>
                    ...
                    <div class="form-check form-check-inline mb-0 me-4">
                      <input class="form-check-input" type="radio" name="inlineRadioOptions" id="bad"
                        value="2"/>
                    ...
                    <div class="form-check form-check-inline mb-0 me-4">
                      <input class="form-check-input" type="radio" name="inlineRadioOptions" id="good"
                        value="4" />
                    ...
                    <div class="form-check form-check-inline mb-0 me-4">
                      <input class="form-check-input" type="radio" name="inlineRadioOptions" id="very_good"
                        value="5" />
                  ...
                  <div class="form-outline mb-4">
                      ...
                      <input type="text" id="diseases" class="form-control form-control-lg" placeholder="Введите Ваши заболевания" required/>
                  </div>  

                  <div class="row">
                    <div class="col-md-4 mb-4">
                      <div class="form-check form-switch">
                        <input class="form-check-input" type="checkbox" id="smoking">
                    ...
                    <div class="col-md-4 mb-4">
                      <div class="form-check form-switch">
                        <input class="form-check-input" type="checkbox" id="gamer">
                  ...
                  <div class="row">
                    <div class="col-md-6 mb-4">
                      ...
                      <select class="form-select form-select-lg" id="alcohol_frequency" required>
                        <option value="" selected></option>
                  ...
                  <div data-mdb-input-init class="form-outline mb-4">
                    ...
                    <input type="text" id="sports" class="form-control form-control-lg" placeholder="Каким спортом занимаетесь?" required/>
                  </div>
